...
50.times do 
  ...
  item = Item.create(title: Faker::Team.name, category: categories.sample, genre: genres.sample, length: 30, creator_id: User.all.sample.id)
  until item.valid?
    Item.title = Faker::Team.name
  end
end
